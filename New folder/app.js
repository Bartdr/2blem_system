// ===================================================
// ✅ FIREBASE CONFIG — SDK Compat (sintaxis v8)
// Funciona con firebase-app-compat.js en el HTML
// ===================================================
...
try {
  // ✅ Con los scripts -compat.js, firebase está disponible globalmente
...
async function reservarCita() {
  ...
  try {
    // ✅ Guardar en Firestore — colección "citas"
    const docRef = await db.collection("citas").add({
      ...
      estado:    "pendiente"   // útil para el panel del barbero
    });
    ...
    // ⚠️ Si el error es de permisos, muestra mensaje claro
    if (error.code === 'permission-denied') {
      showNotification('error', 'Sin permisos en la base de datos. Revisa las reglas de Firestore.');
    } else {
...
console.log("📄 app.js cargado — Firebase compat listo");
